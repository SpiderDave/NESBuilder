...
function Pal_cmd(name, dummy,t)
    -- Get the specific widget clicked
    --c = Python.getControl(string.format("%s_%02x",name,t.cellNum))
    --c = t.cell
...
function About_cmd()
    Python.exec("webbrowser.get('windows-default').open('http://www.google.com')")
end
